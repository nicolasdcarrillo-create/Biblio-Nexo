      ...
      <div class="border-t border-stone-200 pt-3 mt-3">
        <div class="flex items-start justify-between gap-3 flex-wrap">
          ...
          <div class="border-t border-stone-200 pt-4 mt-4">
            <button data-prestar-libro="${t(String(e.id))}" ${a?``:`disabled`}
